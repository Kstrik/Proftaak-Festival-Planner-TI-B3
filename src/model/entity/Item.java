...
public class Item {
    ...
    public Item(int id, int teacher_id, int classroom_id, String name, LocalDateTime start, LocalDateTime end) {
    ...
    public String toString() {
        ...
        sb.append("\"teacher_id\":")   .append(this.teacher_id)                           .append("\",\n");
        sb.append("\"classroom_id\":") .append(this.classroom_id)                         .append("\",\n");
